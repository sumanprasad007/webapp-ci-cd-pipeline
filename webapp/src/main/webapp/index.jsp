				...
				<nav class="navbar navbar-inverse" role="navigation">
					...
					<div id="main-nav" class="collapse navbar-collapse">
						<ul class="nav navbar-nav" id="mainNav">
							...
							<li><a href="https://programmingwithsumanprasad.blogspot.com/" class="scroll-link">Blogs</a>
							</li>
			...
			<div class="grid-item col-md-6">
				<div class="item-content clearfix">
					<div class="text-content">
						...
						<a href="home.php"></a><img style="width: 40rem;" src="images/image.png" alt="">
				...
				<div class="item-content clearfix">
					<div class="text-content">
						...
						<img style="width: 25rem;"
							src="images/Fun-with-Caesar-Shift-Cipher-store-product-image-500x500.jpg"
							alt="">
				...
				<form method="post" action="" id="contactfrm" role="form">
					...
					<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<input name="phone" class="form-control required digits" type="number" id="phone" size="30"
				...
				<div class="row">
					<div class="col-sm-12">
						Copyright 2021 All Rights Reserved <div class="pull-right">Click to check my Blogs <a
								href="https://programmingwithsumanprasad.blogspot.com/" target="blank">Suman Praad</a>
						</div>
					</div>
				</div> <!-- / .row -->
			</div>
